...
export function IconLotus({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden>
      <path d="M12 3c-1.2 2.2-3.5 4-6 4.2C5 10.5 5.5 14 8 16c1.5-2 4-3 8-3s6.5 1 8 3c2.5-2 3-5.5 1-8.8-2.5-.2-4.8-2-6-4.2z" opacity=".35" />
      <path d="M12 6.5c-.8 1.5-2.3 2.8-4 3C7.5 11 8 13.5 10 15c1-1.2 2.8-1.8 5-1.8s4 .6 5 1.8c2-1.5 2.5-4 2-5.5-1.7-.2-3.2-1.5-4-3z" />
    </svg>
  );
}

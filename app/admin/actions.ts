...
export async function updateSiteConfigAction(formData: FormData) {
  ...
  await prisma.siteConfig.update({
    ...
    data: {
      ...
      popupImageUrl: emptyToNull(formData.get("popupImageUrl")),
      popupCtaLabel: emptyToNull(formData.get("popupCtaLabel")),
      popupCtaUrl: emptyToNull(formData.get("popupCtaUrl")),
